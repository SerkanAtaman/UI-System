...
{
    public class ResolveMultipleWindowConflictProccess : UIProccess
    {
        public override string Description => "Resolve Multiple Window Conflicts Proccess";
        ...
        public ResolveMultipleWindowConflictProccess(UIWindow[] windows, List<UIWindow> openedWindows, bool resolveImmediately = false)
        {
            ...
            _conflictedWindows = UIHelper.GetConflictedWindows(windows, openedWindows).ToArray();
        }
